...
**Компьютерные сети**: системы связи между устройствами.

**Закон Меткалфа**: ценность сети пропорциональна квадрату числа ее пользователей.
...
**Топологии локальных сетей**: шина, звезда, кольцо.
...
- **Модели**:
  ...
  - B2C
  - C2C
- **Интранет** — корпоративная сеть.
- **Экстранет** — расширенная сеть для партнеров.
...
**Категории ПО**:
- **Системное ПО**: ОС, драйверы, утилиты.
- **Прикладное ПО**:
  - Для работы с текстами (Word)
  - Для графики (Photoshop)
  - Для анализа данных (Excel)
- **Программы для работы в интернете**:
  - Браузеры
  - Почтовые клиенты
  - ПО для совместной работы (Groupware)
